...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE info SET Name=?, Vehicle=?, DATE=?, Plate=? WHERE Serial=?";
    $stmt = mysqli_prepare($_connections, $sql);
    mysqli_stmt_bind_param($stmt, "sssss", $name, $vehicle, $date, $plate, $serial);
...
if (isset($_GET['id']) && !empty($_GET['id'])) {
    $serial = $_GET['id'];
    $sql = "SELECT * FROM info WHERE Serial=?";
    $stmt = mysqli_prepare($_connections, $sql);
    ...
    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
        ...
        <div class="content">
            <div class="fillup-box">
                ...
                <input type="text" placeholder="fullname" name="name" value="<?php echo htmlspecialchars($name); ?>">
            </div>
            <div class="fillup-box">
                <label for="Vehicle">VehicleType</label>
                <input type="text" placeholder="Vehicle Type" name="Vehicle" value="<?php echo htmlspecialchars($vehicle); ?>">
            </div>
            <div class="fillup-box">
            ...
            <div class="fillup-box">
                ...
                <input type="text" placeholder="Plate Number" name="plate" value="<?php echo htmlspecialchars($plate); ?>">
            </div>
            <div class="btn2">
...
function menuBtnChange() {
 if(sidebar.classList.contains("open")){
  ...
  <?php
include('Action/connections.php'); // Assuming 'connections.php' contains your database connection logic
